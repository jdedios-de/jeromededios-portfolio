                    ...
                    <section className="container-grid pt-10 sm:pt-14">
                        <div className="grid grid-cols-1 lg:grid-cols-[1fr,auto] gap-6 lg:gap-8">
                            <div className="card hero-card p-5 md:p-6">
                                ...
                                <div
                                    className="mt-8 p-5 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 border border-blue-200 dark:border-blue-800">
                                    <div className="flex items-start gap-3">
                                        <div
                                            className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-600 dark:bg-blue-500 flex items-center justify-center">
                                            <svg
                                                aria-hidden="true"
                                        ...
                                        <div>
                                            ...
                                            <ul className="mt-2 space-y-1.5 text-sm text-blue-700 dark:text-blue-300 list-disc list-inside">
                                                <li>
                                                    <strong>German Integration Course B1</strong> in progress — weekly
                                                    lessons, online.
                                                </li>
                                            </ul>
                                            <ul className="mt-2 space-y-1.5 text-sm text-blue-700 dark:text-blue-300 list-disc list-inside">
                                                <li>
                                                    <strong>German Drivers License</strong> coming soon
                                                </li>
                                            </ul>
                                ...
                                <div
                                    className="mt-6 p-4 rounded-xl bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-950/30 dark:to-blue-950/30 border border-green-200 dark:border-green-800/50 shadow-sm">
                                    <div className="flex items-center gap-3">
                                        {/* Icon: certificate badge with green-blue gradient */}
                                        <div
                                            className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center text-white">
                                            <svg
                                                className="w-6 h-6"
                                                fill="none"
                                                stroke="currentColor"
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="mt-1 text-sm text-green-800 dark:text-green-300">
                                                • Internship Certificates (AI Engineering + Cloud Engineering)
                                            </p>
                                        ...
                                        <div className="card p-5">
                                            <div className="flex gap-4">
                                                <div className="flex-shrink-0">
                                                    <div
                                                        className="w-12 h-12 rounded-full bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center text-white font-bold text-sm">
                                                        WB
                                                    </div>
                                                </div>
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-xs text-blue-500 dark:text-blue-400 mt-1">
                                                        <a href="https://www.webeet.io" target="_blank"
                                                           rel="noopener noreferrer">
                                                            https://www.webeet.io
                                                        </a>
                                                    </p>
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div className="card p-5">
                                            <div className="flex gap-4">
                                                <div className="flex-shrink-0">
                                                    <div
                                                        className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm">
                                                        MSIT
                                                    </div>
                                                </div>
                                                <div className="flex-1">
                                                    <h3 className="font-semibold text-lg">Master School Institute of
                                                        Technology – Berlin, Germany</h3>
                                                    <p className="text-sm text-neutral-600 dark:text-neutral-400">
                                                        Cloud Engineering & Generative AI Engineering
                                                    </p>
                                                    <p className="text-sm text-blue-500 dark:text-blue-400">
                                                        <a href="https://joinmsit.de" target="_blank"
                                                           rel="noopener noreferrer">
                                                            https://joinmsit.de
                                                        </a>
                                                    </p>
                                    ...
                                    {skill}
                                                    ...
                                                    <div className="mt-4 border-l-4 border-purple-500 pl-4">
                                                        ...
                                                        <ul className="mt-2 text-sm text-neutral-700 dark:text-neutral-300 list-disc list-inside space-y-1">
                                                            <li>Intensive online training in software & AI engineering
                                                            </li>
                                  ...
                                  {skill}
                                        ...
                                        <div className="card p-5">
                                            <div className="flex gap-4">
                                                <div className="flex-shrink-0">
                                                    <div
                                                        className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center text-white font-bold text-sm">
                                                        ADFC
                                                    </div>
                                                </div>
                                                <div className="flex-1">
