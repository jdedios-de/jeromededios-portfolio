...
export const projects: Project[] = [
  {
    ...
    tags: [
      "Used Terraform for Infrastructure as Code to manage EC2 and RDS resources.",
  ...
  },
  {
    ...
    tags: [
      "Python (FastAPI): Used to build a modular, high-performance backend API with dependency injection for maintainable and testable code.",
      "SQLModel / PostgreSQL: Used for object-relational mapping and persistent data storage to reliably manage patient records and application data.",
      "Pydantic: Applied for data validation to ensure all API requests and responses are clean, consistent, and error-free.",
      "OAuth2: Implemented authentication to securely control user access and protect sensitive healthcare data.",
      "Generative AI & RAG: Integrated AI-powered chat and report generation to assist nurses with patient interactions and documentation.",
      "Logfire & Loguru: Configured structured logging and monitoring to track application behavior and ensure operational reliability.",
    ],
    image: "/images/project-placeholder.svg",
  ...
  },
  {
    ...
    tags: [
      "FastAPI: Used to build lightweight, high-performance APIs with asynchronous endpoints and dependency injection for modular, scalable microservices.",
  ...
  },
  {
    ...
    tags: [
      "React (with TypeScript): Used to build a dynamic, component-based frontend with type safety, improving code reliability and maintainability.",
